...
class ATMInterface:
    ...
    def show_main_menu(self):
        ...
        tk.Button(self.root, text="Deposit", command=self.deposit_funds, width=20).pack(pady=5)
        tk.Button(self.root, text="Withdraw", command=self.withdraw_funds, width=20).pack(pady=5)
        tk.Button(self.root, text="Transaction History", command=self.show_transactions, width=20).pack(pady=5)
        tk.Button(self.root, text="Logout", command=self.root.quit, width=20).pack(pady=5)
